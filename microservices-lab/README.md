...
A simple microservices system with 4 services using polyglot architecture.
...
| Order Service | Flask (Python) | 8082 |
| Payment Service | Flask (Python) | 8083 |
| API Gateway | Express.js (Node) | 8080 |
